...
import com.stkj.cashier.common.ui.widget.pageindicator.ViewPagerIndicator;
import com.stkj.cashier.common.utils.DensityUtil;
...
public class CommonLooperBannerLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        TypedArray a = context.obtainStyledAttributes(attributeSet, R.styleable.CommonLooperBannerLayout);
